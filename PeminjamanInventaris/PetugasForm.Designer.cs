namespace PeminjamanInventaris
{
    partial class PetugasForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Controls.Add(this.txtOrganisasi);
            this.Controls.Add(this.txtNoTlp);
            this.Controls.Add(this.txtKodePos);
            this.Controls.Add(this.txtAKota);
            this.Controls.Add(this.txtAJalan);
            ...
            this.Controls.Add(this.labelAJalan);
            this.Controls.Add(this.labelNamaPetugas);
            this.Controls.Add(this.labelIDPetugas);
